...
export const useRifm = (props: Args): RenderProps => {
    ...
    const onChange = (evt: NativeSyntheticEvent<TextInputChangeEventData>) => {
        ...
        valueRef.current = [
            ...
            evt.target as any as HTMLInputElement | HTMLTextAreaElement, // input
    ...
    if (
        ...
        React.useLayoutEffect(() => {
            ...
            const acceptedCharIndexAfterDelete =
                valueAfterSelectionStart.search(props.accept || /\d/g)
            ...
            const valueBeforeSelectionStart = clean(
                eventValue.substr(0, input.selectionStart || 0)
            )
