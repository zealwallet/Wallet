...
import { DisconnectLogoWithMM } from '@zeal/uikit/Icon/DisconnectLogoWithMM'
...
export const Minimize = ({ onMsg, installationId }: Props) => {
        ...
        >
            <IconButton
                ...
                aria-label={formatMessage({
                    id: 'connected-to-mm-icon-label',
                    defaultMessage: 'Connected to MetaMask',
                })}
            >
